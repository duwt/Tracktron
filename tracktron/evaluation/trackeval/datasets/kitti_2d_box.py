...
class Kitti2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'SEQMAP_FILE': None,  # Directly specify seqmap file (if none use GT_FOLDER/evaluate_tracking.seqmap.val)
    ...
    def __init__(self, config=None):
        ...
        if seqmap_file is None:
            seqmap_file = os.path.join(self.gt_fol, 'evaluate_tracking.seqmap.val')
            ...
            for row in reader:
                if len(row) >= 4:
                    ...
                    if not self.data_is_zipped:
                        curr_file = os.path.join(self.gt_fol, seq + '.txt')
